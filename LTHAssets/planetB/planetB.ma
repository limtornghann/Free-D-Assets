...
//Name: planetB.ma
//Last modified: Thu, Dec 19, 2013 07:08:58 AM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -52.538352729783909 -111.79999999998552 0 ;
...
createNode transform -n "polySurface1" -p "planetB:planetB";
...
createNode transform -n "polySurface2" -p "planetB:planetB";
createNode mesh -n "polySurfaceShape2" -p "polySurface2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "transform1" -p "planetB:planetB";
	setAttr ".v" no;
createNode mesh -n "planetB:planetBShape" -p "transform1";
	setAttr -k off ".v";
	setAttr ".io" yes;
	...
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr -s 20 ".pt";
	setAttr ".pt[0]" -type "float3" 0.027329598 4.7683715e-009 -0.024499409 ;
	setAttr ".pt[1]" -type "float3" 0.010438973 4.7683715e-009 -0.039640874 ;
	setAttr ".pt[2]" -type "float3" -0.010438973 4.7683715e-009 -0.039640866 ;
	setAttr ".pt[3]" -type "float3" -0.027329581 4.7683715e-009 -0.0244994 ;
	setAttr ".pt[4]" -type "float3" -0.033781219 4.7683715e-009 8.3106535e-009 ;
	setAttr ".pt[5]" -type "float3" -0.027329586 4.7683715e-009 0.024499414 ;
	setAttr ".pt[6]" -type "float3" -0.010438967 4.7683715e-009 0.039640874 ;
	setAttr ".pt[7]" -type "float3" 0.010438975 4.7683715e-009 0.039640866 ;
	setAttr ".pt[8]" -type "float3" 0.027329581 4.7683715e-009 0.024499409 ;
	setAttr ".pt[9]" -type "float3" 0.033781219 4.7683715e-009 4.0567931e-009 ;
	setAttr ".pt[40]" -type "float3" 0.027329605 -4.7683715e-009 -0.024499426 ;
	setAttr ".pt[41]" -type "float3" 0.010438966 -4.7683715e-009 -0.039640885 ;
	setAttr ".pt[42]" -type "float3" -0.010438966 -4.7683715e-009 -0.039640848 ;
	setAttr ".pt[43]" -type "float3" -0.027329613 -4.7683715e-009 -0.024499424 ;
	setAttr ".pt[44]" -type "float3" -0.033781271 -4.7683715e-009 8.3106615e-009 ;
	setAttr ".pt[45]" -type "float3" -0.027329601 -4.7683715e-009 0.024499422 ;
	setAttr ".pt[46]" -type "float3" -0.010438953 -4.7683715e-009 0.039640885 ;
	setAttr ".pt[47]" -type "float3" 0.010438993 -4.7683715e-009 0.039640885 ;
	setAttr ".pt[48]" -type "float3" 0.027329613 -4.7683715e-009 0.024499426 ;
	setAttr ".pt[49]" -type "float3" 0.033781271 -4.7683715e-009 4.0567918e-009 ;
...
connectAttr "groupParts1.og" "planetB:planetBShape.i";
connectAttr "groupId1.id" "planetB:planetBShape.iog.og[0].gid";
connectAttr "lambert2SG.mwc" "planetB:planetBShape.iog.og[0].gco";
connectAttr "groupId2.id" "planetB:planetBShape.ciog.cog[0].cgid";
...
connectAttr "planetB:planetBShape.iog.og[0]" "lambert2SG.dsm" -na;
connectAttr "planetB:planetBShape.ciog.cog[0]" "lambert2SG.dsm" -na;
...
connectAttr "planetB:planetBShape.o" "polySeparate1.ip";
connectAttr "planetB:polyDelEdge1.out" "groupParts1.ig";
