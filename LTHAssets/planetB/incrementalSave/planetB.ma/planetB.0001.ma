...
//Name: planetB.ma
//Last modified: Thu, Dec 19, 2013 04:31:14 AM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.8286899712607516 2.2458223766162981 0.15998964158887846 ;
	setAttr ".r" -type "double3" -50.738352730123268 -85.000000000003851 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.9005899130547035;
	setAttr ".ow" 0.1;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "C:/Users/John/Desktop/planet/planetBColor.png";
